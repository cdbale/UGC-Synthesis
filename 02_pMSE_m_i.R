...
for (sim in 1:nsim){
  ...
  r_state <- pMSE_for_sequence(origdata, Y_syn_conf, Z, rp, 'm + i')
  r_state_avg <- sapply(r_state, mean)
...
# look at probabilities for example reviews

# our first example is ZITA
zita_row <- j_targets['Row'][j_targets['Name'] == "ZITA"]

high_state_preds <- predict(state_model, newx=r_X, s=LAMBDA[3], type='response')
med_state_preds <- predict(state_model, newx=r_X, s=LAMBDA[2], type='response')
low_state_preds <- predict(state_model, newx=r_X, s=LAMBDA[1], type='response')

high_rating_preds <- predict(rating_model, newx=X, s=LAMBDA[3], type='response')
med_rating_preds <- predict(rating_model, newx=X, s=LAMBDA[2], type='response')
low_rating_preds <- predict(rating_model, newx=X, s=LAMBDA[1], type='response')

high_state_preds[data2['Row']==zita_row]
rmultinom(n=1, size=1, prob=high_state_preds[data2['Row']==zita_row])

med_state_preds[data2['Row']==zita_row]
rmultinom(n=1, size=1, prob=med_state_preds[data2['Row']==zita_row])

low_state_preds[data2['Row']==zita_row]
rmultinom(n=1, size=1, prob=low_state_preds[data2['Row']==zita_row])

high_rating_preds[data2['Row']==zita_row]
rmultinom(n=1, size=1, prob=high_rating_preds[data2['Row']==zita_row])

med_rating_preds[data2['Row']==zita_row]
rmultinom(n=1, size=1, prob=med_rating_preds[data2['Row']==zita_row])

low_rating_preds[data2['Row']==zita_row]
rmultinom(n=1, size=1, prob=low_rating_preds[data2['Row']==zita_row])

data2$Text[data2['Row']==zita_row]
data_targets$Text[data_targets$Name=="ZITA"]

##############

# second example is William
william_row <- j_targets['Row'][j_targets['Name'] == "WILLIAM"]

high_state_preds[data2['Row']==william_row]
rmultinom(n=1, size=1, prob=high_state_preds[data2['Row']==william_row])

med_state_preds[data2['Row']==william_row]
rmultinom(n=1, size=1, prob=med_state_preds[data2['Row']==william_row])

low_state_preds[data2['Row']==william_row]
rmultinom(n=1, size=1, prob=low_state_preds[data2['Row']==william_row])

high_rating_preds[data2['Row']==william_row]
rmultinom(n=1, size=1, prob=high_rating_preds[data2['Row']==william_row])

med_rating_preds[data2['Row']==william_row]
rmultinom(n=1, size=1, prob=med_rating_preds[data2['Row']==william_row])

low_rating_preds[data2['Row']==william_row]
rmultinom(n=1, size=1, prob=low_rating_preds[data2['Row']==william_row])

data2$Text[data2['Row']==william_row]
data_targets$Text[data_targets$Name=="WILLIAM"]
